...
-- ConcertSchedule
INSERT INTO concert_schedule (id, concert_id, perform_date, total_seat, available_seat_num, available_status, created_at, updated_at, deleted_at) VALUES    (1, 1, '2024-11-01', 50, 50, 'AVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

INSERT INTO concert_schedule (id, concert_id, perform_date, total_seat, available_seat_num, available_status, created_at, updated_at, deleted_at) VALUES    (2, 1, '2024-11-02', 50, 50, 'AVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

INSERT INTO concert_schedule (id, concert_id, perform_date, total_seat, available_seat_num, available_status, created_at, updated_at, deleted_at) VALUES    (3, 2, '2024-11-03', 50, 50, 'AVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

INSERT INTO concert_schedule (id, concert_id, perform_date, total_seat, available_seat_num, available_status, created_at, updated_at, deleted_at) VALUES    (4, 2, '2024-11-04', 50, 0, 'UNAVAILABLE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
INSERT INTO users (id, name, point, created_at, updated_at, deleted_at) VALUES (2, '유저2', 25000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

INSERT INTO users (id, name, point, created_at, updated_at, deleted_at) VALUES (3, '유저3', 15000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);

-- 1번 유저의 예약: 5번과 6번 좌석
INSERT INTO reservation (id, user_id, concert_schedule_id, total_price, reserved, reserve_request_at, reserve_expired_at, reserved_at, created_at, updated_at)VALUES (1, 1, 1, 40000, 'TEMP_RESERVED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '5' MINUTE, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- 2번 유저의 예약: 1번과 2번 좌석
INSERT INTO reservation (id, user_id, concert_schedule_id, total_price, reserved, reserve_request_at, reserve_expired_at, reserved_at, created_at, updated_at)VALUES (2, 2, 1, 60000, 'TEMP_RESERVED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '5' MINUTE, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- 3번 유저의 만료된 예약: 3번 좌석
INSERT INTO reservation (id, user_id, concert_schedule_id, total_price, reserved, reserve_request_at, reserve_expired_at, reserved_at, created_at, updated_at)VALUES (3, 3, 1, 25000, 'TEMP_RESERVED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
